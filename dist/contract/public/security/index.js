...
class VerifiedSecurity extends index_1.VerifiedContract {
    ...
    async addToBalance(_isin, _amount, _tokenHolder, _currency, _hashedMessage, _v, _r, _s, options) {
        ...
        return this.callContract(FUNCTIONS.ADDBALANCE, _isin, _amount, _tokenHolder, this.sanitiseInput(index_1.DATATYPES.BYTE32, _currency), this.sanitiseInput(index_1.DATATYPES.BYTE32, _hashedMessage), _v, this.sanitiseInput(index_1.DATATYPES.BYTE32, _r), this.sanitiseInput(index_1.DATATYPES.BYTE32, _s), options);
    }
