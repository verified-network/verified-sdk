...
import {
  abi,
  networks,
} from "../../../abi/assetmanager/balancer/MarginIssueManager.json";
...
export default class MarginIssueManager extends VerifiedContract {
  ...
  public async issueProduct(
    ...
    return this.callContract(
      FUNCTIONS.ISSUEPRODUCT,
      security,
      this.sanitiseInput(DATATYPES.BYTE32, securityType),
      currency,
      this.sanitiseInput(DATATYPES.BYTE32, cficode),
      securityAmount,
      minOrderSize,
      currencyAmount,
      margin,
  ...
  public async getPool(poolId: string, options?: Options): any {
    await this.validateInput(DATATYPES.STRING, poolId);
    return this.callContract(
      FUNCTIONS.GETCOLLATERAL,
      this.sanitiseInput(DATATYPES.BYTE32, poolId),
