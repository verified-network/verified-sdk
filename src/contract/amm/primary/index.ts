...
export default class PrimaryIssueManager extends VerifiedContract {
  ...
  public async offer(
    ...
    return this.callContract(
      FUNCTIONS.OFFER,
      owned,
      this.sanitiseInput(DATATYPES.BYTE32, isin),
      offered,
      tomatch,
      desired,
      min,
   ...
   */
  public async getOffered(offered: string, options?: Options): any {
    await this.validateInput(DATATYPES.ADDRESS, offered);
   ...
   */
  public async getAllotedStake(offered: string, options?: Options): any {
    await this.validateInput(DATATYPES.ADDRESS, offered);
   ...
   */
  public async getLiquidityProviders(security: string, options?: Options): any {
  ...
  public async close(security: string, options?: Options): any {
    await this.validateInput(DATATYPES.ADDRESS, security);
  ...
  public async settle(poolId: string, options?: Options): any {
    await this.validateInput(DATATYPES.STRING, poolId);
