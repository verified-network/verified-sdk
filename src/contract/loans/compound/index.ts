...
export default class Compound extends VerifiedContract {
   ...
   * @returns 
   */
    public async submitNewRWA(asset: string, bond: string, apy: string, issuingDocs: string, faceValue: string,
     ...
     * @returns 
     */
    public async postCollateral(asset: string, collateral: string, amount: string,  
                                options?: { gasPrice, gasLimit }): any {
        await this.validateInput(DATATYPES.ADDRESS, asset)
     ...
     * @returns 
     */
     public async borrowBase(base: string, amount: string,  
                                options?: { gasPrice, gasLimit }): any {
     ...
     * @returns 
     */
     public async repayBase(base: string, amount: string,  
                            options?: { gasPrice, gasLimit }): any {
        await this.validateInput(DATATYPES.ADDRESS, base)
        await this.validateInput(DATATYPES.NUMBER, amount)
